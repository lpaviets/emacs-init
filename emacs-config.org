...
There are a few things to consider when mixing Org and LaTeX: how you can use LaTeX /inside/ Org documents, as a way to typeset maths for example; and how you want to export LaTeX fragments or embedded equations, figures, etc.
